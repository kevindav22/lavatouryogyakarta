      ...
      <div className="text-center text-white px-6 sm:px-12 md:px-24 space-y-6 mt-12 sm:mt-16 md:mt-20">
        {companyInfo.nama && (
          <h2
            ...
            data-aos-delay="200"
            className="bg-white inline-block px-6 py-2 rounded-sm text-red-800 font-staatliches tracking-wide font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"
          >
            {companyInfo.nama}
          </h2>
        )}
        ...
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" className="animate-bounce">
          <Button link={linkWhatsapp || '#'} target="_blank" className="bg-green-800 hover:bg-green-700">
            <div className="flex items-center justify-center space-x-2">
              <FontAwesomeIcon icon={faWhatsapp} className="text-3xl sm:text-4xl leading-none mr-1" />
